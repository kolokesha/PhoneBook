...
namespace PhoneBook.Filters.ExceptionFilters;
...
public class HandleExceptionFilter : IExceptionFilter
{
    ...
    {
        _logger.LogError("Error:{errorType}{errorMessage}",context.Exception.GetType().ToString(), context.Exception.Message);
